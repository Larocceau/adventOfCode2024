...
let lists =
    ...
    |> Array.map(
        ...
        | [w1c1; w1c2; w1c3; w1c4; w1c5; ' '; ' '; ' '; w2c1; w2c2; w2c3; w2c4; w2c5]
            ->[|w1c1; w1c2; w1c3; w1c4; w1c5 |]|> System.String |> int, [|w2c1; w2c2; w2c3; w2c4; w2c5 |]|> System.String |>int
...
|> (fun (listA, listB) ->
     ...
     listA |> List.map (fun v -> v * ( frequencies |> Map.tryFind v |> Option.defaultValue 0))
    )
|> List.sum
